...
More information on the values allowed in `--type` is available via the shell command `overturemaps download --help`. More methods to download Overture data are shown in the [documentation](https://docs.overturemaps.org/getting-data/).
